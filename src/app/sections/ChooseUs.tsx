          ...
          <div className="flex flex-col w-full h-[80vh]">
            {galleryData.map((item, index) => (
              ...
              >
                ...
                <div className="collapsed-content absolute inset-0 flex items-center justify-center text-white z-10 backdrop-blur-sm">
                  <div className="text-center">
                    <h3
                      className="text-lg font-semibold text-white font-krona uppercase"
                      style={{
                        letterSpacing: "0.1em",
                ...
                <div className="box-content absolute bottom-4 left-4 right-4 text-white z-10 opacity-0">
                  <h3 className="text-lg font-semibold mb-1 font-krona uppercase">
                    {item.title}
                  </h3>
                  <div className="mt-2">
        ...
        <div className="flex items-center h-[70vh] w-full my-5">
          {galleryData.map((item, index) => (
            ...
            >
              ...
              <div className="collapsed-content absolute inset-0 flex items-center justify-center text-white z-10 backdrop-blur-sm">
                <div
                  className="rotated-title text-2xl font-semibold text-white font-krona uppercase"
                  style={{
              ...
              <div className="box-content absolute bottom-6 left-6 right-6 text-white z-10 opacity-0">
                <h3 className="text-2xl font-semibold mb-2 font-krona uppercase">
                  {item.title}
                </h3>
